//
//  AudioPlaybackExtensionAudioUnit.mm
//  AudioPlaybackExtension
//
//  Created by T.R. Larsen on 10/11/23.
//

#import "AudioPlaybackExtensionAudioUnit.h"

#import <AVFoundation/AVFoundation.h>
#import <CoreAudioKit/AUViewController.h>

#import "AudioPlaybackExtensionAUProcessHelper.hpp"
#import "AudioPlaybackExtensionDSPKernel.hpp"


// Define parameter addresses.

@interface AudioPlaybackExtensionAudioUnit ()
...
@implementation AudioPlaybackExtensionAudioUnit {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    AudioPlaybackExtensionDSPKernel _kernel;
...
- (void)setupParameterCallbacks {
    ...
    __block AudioPlaybackExtensionDSPKernel *kernel = &_kernel;
