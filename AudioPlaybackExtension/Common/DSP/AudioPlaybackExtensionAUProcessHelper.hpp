//
//  AudioPlaybackExtensionAUProcessHelper.hpp
...
#include <vector>
#include "AudioPlaybackExtensionDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(AudioPlaybackExtensionDSPKernel& kernel, UInt32 outputChannelCount)
    : mKernel{kernel},
...
private:
    AudioPlaybackExtensionDSPKernel& mKernel;
