//
//  AudioPlaybackExtensionDSPKernel.hpp
...
#import "AudioPlaybackExtension-Swift.h"
#import "AudioPlaybackExtensionParameterAddresses.h"

/*
 AudioPlaybackExtensionDSPKernel
 As a non-ObjC class, this is safe to use from render thread.
 */
class AudioPlaybackExtensionDSPKernel {
public:
    ...
    // Add a case for each parameter in AudioPlaybackExtensionParameterAddresses.h
    void setParameter(AUParameterAddress address, AUValue value) {
        switch (address) {
            case AudioPlaybackExtensionParameterAddress::gain:
                mGain = value;
                break;
        }
    }
